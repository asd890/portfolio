  ...
  return (
    ...
    >
      {project.image && !failed ? (
        ...
        <div className="absolute inset-0 flex items-center justify-center transition-transform duration-[800ms] ease-out group-hover:scale-[1.04]">
          <span
...
export default function V2Projects() {
  ...
  return (
    <section ref={ref} className="mx-auto max-w-3xl px-6 pb-28 md:pb-36">
      {/* Header */}
      <motion.div
        ...
        {projects.map((p, i) => (
          ...
          >
            <Link
              ...
              className="group block rounded-3xl bg-[#eceae5] p-3 transition-colors duration-300 hover:bg-[#e6e4de] cursor-none"
            >
              {/* Image */}
